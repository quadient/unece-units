...
public static partial class Units
{
    public static bool TryGetByCommonCode(string commonCode, [NotNullWhen(returnValue: true)] out IUnit? unit)
    {
        unit = commonCode switch
        {
            ...
            "81" => Henry,
            "84" => KilopoundforcePerSquareInch,
            "85" => FootPoundforce,
            ...
            "A50" => DyneSecondPerCubicCentimetre,
            "A51" => DyneSecondPerCentimetre,
            "A52" => DyneSecondPerCentimetreToTheFifthPower,
            "A53" => Electronvolt,
            "A54" => ElectronvoltPerMetre,
            "A55" => ElectronvoltSquareMetre,
            "A56" => ElectronvoltSquareMetrePerKilogram,
            "A57" => Erg,
            "A58" => ErgPerCentimetre,
            "A59" => Unit8partCloudCover,
            "A6" => AmperePerSquareMetreKelvinSquared,
            "A60" => ErgPerCubicCentimetre,
            "A61" => ErgPerGram,
            "A62" => ErgPerGramSecond,
            "A63" => ErgPerSecond,
            "A64" => ErgPerSecondSquareCentimetre,
            "A65" => ErgPerSquareCentimetreSecond,
            "A66" => ErgSquareCentimetre,
            "A67" => ErgSquareCentimetrePerGram,
            "A68" => Exajoule,
            "A69" => FaradPerMetre,
            ...
            "A75" => FreightTon,
            "A76" => Gal,
            "A77" => GaussianCGSCentimetregramsecondSystemUnitOfDisplacement,
            "A78" => GaussianCGSCentimetregramsecondSystemUnitOfElectricCurrent,
            "A79" => GaussianCGSCentimetregramsecondSystemUnitOfElectricCharge,
            "A8" => AmpereSecond,
            "A80" => GaussianCGSCentimetregramsecondSystemUnitOfElectricFieldStrength,
            "A81" => GaussianCGSCentimetregramsecondSystemUnitOfElectricPolarization,
            "A82" => GaussianCGSCentimetregramsecondSystemUnitOfElectricPotential,
            "A83" => GaussianCGSCentimetregramsecondSystemUnitOfMagnetization,
            ...
            "B36" => CalorieThermochemicalPerGram,
            "B37" => Kilogramforce,
            "B38" => KilogramforceMetre,
            "B39" => KilogramforceMetrePerSecond,
            "B4" => BarrelImperial,
            "B40" => KilogramforcePerSquareMetre,
            ...
            "D33" => Tesla,
            "D34" => Tex,
            "D35" => CalorieThermochemical,
            "D36" => Megabit,
            "D37" => CalorieThermochemicalPerGramKelvin,
            "D38" => CalorieThermochemicalPerSecondCentimetreKelvin,
            "D39" => CalorieThermochemicalPerSecondSquareCentimetreKelvin,
            ...
            "D70" => CalorieInternationalTable,
            "D71" => CalorieInternationalTablePerSecondCentimetreKelvin,
            "D72" => CalorieInternationalTablePerSecondSquareCentimetreKelvin,
            "D73" => JouleSquareMetre,
            "D74" => KilogramPerMole,
            "D75" => CalorieInternationalTablePerGram,
            "D76" => CalorieInternationalTablePerGramKelvin,
            "D77" => Megacoulomb,
            ...
            "H77" => ModuleWidth,
            "H78" => ConventionalCentimetreOfWater,
            "H79" => FrenchGauge,
            "H80" => RackUnit,
            ...
            "HMT" => Hectometre,
            "HN" => ConventionalMillimetreOfMercury,
            "HP" => ConventionalMillimetreOfWater,
